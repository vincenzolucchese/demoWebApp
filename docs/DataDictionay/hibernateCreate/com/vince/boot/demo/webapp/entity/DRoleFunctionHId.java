...
/**
 * DRoleFunctionHId generated by hbm2java
 */
@Embeddable
public class DRoleFunctionHId  implements java.io.Serializable {
    ...
    public DRoleFunctionHId() {
    }

	
    public DRoleFunctionHId(Date yearRefer, char crudType) {
        this.yearRefer = yearRefer;
        this.crudType = crudType;
    }
    public DRoleFunctionHId(Integer userInsert, Integer userUpdate, Date timeInsert, Date timeUpdate, Long id, Date yearRefer, char crudType) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DRoleFunctionHId) ) return false;
		 DRoleFunctionHId castOther = ( DRoleFunctionHId ) other; 

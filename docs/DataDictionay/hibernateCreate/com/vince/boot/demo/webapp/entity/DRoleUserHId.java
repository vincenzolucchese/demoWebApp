...
/**
 * DRoleUserHId generated by hbm2java
 */
@Embeddable
public class DRoleUserHId  implements java.io.Serializable {
    ...
    public DRoleUserHId(Date yearRefer, char crudType) {
        this.yearRefer = yearRefer;
        this.crudType = crudType;
    }
    public DRoleUserHId(Integer userInsert, Integer userUpdate, Date timeInsert, Date timeUpdate, Long id, String roleCode, String roleDescription, Date yearRefer, char crudType) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DRoleUserHId) ) return false;
		 DRoleUserHId castOther = ( DRoleUserHId ) other; 
 ...
 && ( (this.getRoleDescription()==castOther.getRoleDescription()) || ( this.getRoleDescription()!=null && castOther.getRoleDescription()!=null && this.getRoleDescription().equals(castOther.getRoleDescription()) ) )

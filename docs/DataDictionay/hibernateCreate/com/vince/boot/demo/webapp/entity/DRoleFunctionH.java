...
/**
 * DRoleFunctionH generated by hbm2java
 */
@Entity
@Table(name="d_role_function_h"
    ,catalog="demo"
)
public class DRoleFunctionH  implements java.io.Serializable {


     private DRoleFunctionHId id;

    public DRoleFunctionH() {
    }

    public DRoleFunctionH(DRoleFunctionHId id) {
       this.id = id;
    }
    ...
    public DRoleFunctionHId getId() {
        return this.id;
    }
    
    public void setId(DRoleFunctionHId id) {
        this.id = id;
    }

...
public class DGeoLocal  implements java.io.Serializable {
    ...
    public DGeoLocal(long id, String userInsert, Date timeInsert, Date yearRefer) {
        this.id = id;
        this.userInsert = userInsert;
        this.timeInsert = timeInsert;
        this.yearRefer = yearRefer;
    }
    public DGeoLocal(long id, String userInsert, String userUpdate, Date timeInsert, Date timeUpdate, Date yearRefer) {
       this.id = id;
       this.userInsert = userInsert;

...
/**
 * DSystemPropsH generated by hbm2java
 */
@Entity
@Table(name="d_system_props_h"
    ,catalog="demo"
    , uniqueConstraints = @UniqueConstraint(columnNames="key_prop") 
)
public class DSystemPropsH  implements java.io.Serializable {
    ...
    public DSystemPropsH(long id, String userInsert, Date timeInsert, Date yearRefer, String keyProp, String valueProp) {
        this.id = id;
    ...
    public DSystemPropsH(long id, String userInsert, String userUpdate, Date timeInsert, Date timeUpdate, Date yearRefer, String keyProp, String valueProp) {
       this.id = id;
       this.userInsert = userInsert;

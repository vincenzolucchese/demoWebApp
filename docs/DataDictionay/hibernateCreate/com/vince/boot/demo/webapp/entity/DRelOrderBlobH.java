...
/**
 * DRelOrderBlobH generated by hbm2java
 */
@Entity
@Table(name="d_rel_order_blob_h"
    ,catalog="demo"
)
public class DRelOrderBlobH  implements java.io.Serializable {


     private DRelOrderBlobHId id;

    public DRelOrderBlobH() {
    }

    public DRelOrderBlobH(DRelOrderBlobHId id) {
       this.id = id;
    }
    ...
    @AttributeOverrides( {
        @AttributeOverride(name="fkIdOrder", column=@Column(name="fk_id_order") ), 
    ...
    public DRelOrderBlobHId getId() {
        return this.id;
    }
    
    public void setId(DRelOrderBlobHId id) {
        this.id = id;
    }

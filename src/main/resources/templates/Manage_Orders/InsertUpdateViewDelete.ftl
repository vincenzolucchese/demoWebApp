		          	...
		          	<#list baseFE.fileDocuments as child>
					    <tr>
		                   ...
		                   <@spring.formHiddenInput "baseFE.fileDocuments["+child?index+"].filename"/>
			                ...
			                <td>
			                  	<button class="btn btn-info btn-sm" name="Download" type="submit" value="Download_${child.id}" onClick="removeRequired(this.form)">
							      <span class="glyphicon glyphicon-download"></span> Download
							    </button>
							    <#if baseFE.state== "C" || baseFE.state=="U">
				                   	<button class="btn btn-danger btn-sm" name="Delete" type="submit" value="Delete_${child.id}" onClick="removeRequired(this.form)">
						   ...
						   <#else>
						      ...
						      <td><@spring.formInput "baseFE.fileDocuments["+child?index+"].file" 'class="form-control"' "file" />
						     	 <@spring.showErrors "</br>", "form-control alert-danger" />
						      </td>
			                  <td>
		                      	<button class="btn btn-primary btn-sm" name="Upload" type="submit" value="Upload" onClick="removeRequired(this.form)">

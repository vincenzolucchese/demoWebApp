...
<@layout.standardPage title="Home">
   ...
   <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <h1 class="page-header">Search Order</h1>
	    ...
	    <#if listBeanTable?? && listBeanTable.source?has_content > 
	            ...
	            <table class="table table-striped">
	              ...
	              <tbody>
	              	<#list listBeanTable.source as child>
					    <tr>
					      <td>${child.codeOrder}</td>
		                  <td>${child.dataScadenza}</td>
		                  <td>${child.clients.name}</td>
		                  <td>
		                  	<a class="glyphicon glyphicon-zoom-in" href="<@spring.url '/Manage_Orders/InsertUpdateViewDelete/'/>${child.id}/R" title="Read"></a>
		                    <a class="glyphicon glyphicon-pencil" href="<@spring.url '/Manage_Orders/InsertUpdateViewDelete/'/>${child.id}/U" title="Update"></a>
		                    <a class="glyphicon glyphicon-off" href="<@spring.url '/Manage_Orders/InsertUpdateViewDelete/'/>${child.id}/D" title="Delete"></a>		                  
		                  </td>
					    </tr>
				    </#list>
	              </tbody>

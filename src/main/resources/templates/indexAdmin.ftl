...
<head>
  ...
  <!-- Bootstrap core CSS-->
  <link href="../adminBoot/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <!-- Custom fonts for this template-->
  <link href="../adminBoot/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
  <!-- Page level plugin CSS-->
  <link href="../adminBoot/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">
  <!-- Custom styles for this template-->
  <link href="../adminBoot/css/sb-admin.css" rel="stylesheet">
</head>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <script src="../adminBoot/vendor/chart.js/Chart.min.js"></script>
    <script src="../adminBoot/vendor/datatables/jquery.dataTables.js"></script>
    <script src="../adminBoot/vendor/datatables/dataTables.bootstrap4.js"></script>
    <!-- Custom scripts for all pages-->
    <script src="../adminBoot/js/sb-admin.min.js"></script>
    <!-- Custom scripts for this page-->
    <script src="../adminBoot/js/sb-admin-datatables.min.js"></script>
    <script src="../adminBoot/js/sb-admin-charts.min.js"></script>
  </div>
</body>

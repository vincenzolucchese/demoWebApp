...
//import com.vince.boot.demo.model.OrdersFE;
...
//		
//		PagedListHolder<OrdersFE> listBeanTable = null;		
...
//		}
//		
//		listBeanTable = ordersRepository.findUsersPagedByCriteria(searchBean, 0, 10, "timeInsert", false);
//
...
//			id = new Long(ids);
//			baseFE = ordersRepository.findOneFE(id);
//		}else {
//			
//		}
//		
...
//	public String postRequest(ModelMap model, @Valid @ModelAttribute("baseFE") OrdersFE baseFE, BindingResult result,
//			HttpServletRequest request) {
//		
...
//			usersRepository.delete(baseFE.getId());
//		}else {
//			if(result.hasErrors()){
...
//				return PREFIX_ORDERS+SUFFIX_CRUD;
//			}
//			ordersRepository.saveAllOrder(baseFE, getCurrentUsername());
//	
//		}
//		
...
//	public String deletedDocumentOrder(@ModelAttribute("baseFE") OrdersFE baseFE, BindingResult result, ModelMap model, 
...
//	public String downloaddDocumentOrder(@ModelAttribute("baseFE") OrdersFE baseFE, BindingResult result, ModelMap model, 
...
//	public String uploadDocumentOrder(@ModelAttribute("baseFE") OrdersFE baseFE, BindingResult result, 

...
//
//import com.vince.boot.demo.model.BaseFE;
//import com.vince.boot.demo.model.ClientsFE;
//import com.vince.boot.demo.model.SearchBean;
//
//
//@Controller
...
//			ModelMap model,
//			@ModelAttribute("searchForm") SearchBean searchBean,
//			Principal principal,
...
//		
//		PagedListHolder<ClientsFE> listBeanTable = null;		
...
//		}
//		
//		listBeanTable = clientsRepository.findUsersPagedByCriteria(searchBean, 0, 10, "timeInsert", false);
//
...
////        }
////                    
////        ModelAndView mv = new ModelAndView("PREFIX_CLIENTS/SUFFIX_SEARCH");
////        
////        return  mv;
////    }
//
...
//	public String getRequest(ModelMap model, BaseFE baseFE, @PathVariable Map<String, String> pathVariablesMap) {
...
//			id = new Long(ids);
//			baseFE = clientsRepository.findOneFE(id);
//		}else {
...
//	public String postRequest(ModelMap model, @Valid @ModelAttribute("baseFE") ClientsFE baseFE, BindingResult result,
//			HttpServletRequest request) {
//		
...
//			clientsRepository.delete(baseFE.getId());
//		}else {
//			if(result.hasErrors()){
...
//				return PREFIX_CLIENTS+SUFFIX_CRUD;
//			}
//			clientsRepository.saveAllClient(baseFE, getCurrentUsername());			
//		}
//		
...
//	public String deletedDocument(@ModelAttribute("baseFE") ClientsFE baseFE, BindingResult result, ModelMap model, 
...
//	public String downloaddDocument(@ModelAttribute("baseFE") ClientsFE baseFE, BindingResult result, ModelMap model, 
...
//	public String uploadDocument(@ModelAttribute("baseFE") ClientsFE baseFE, BindingResult result, 

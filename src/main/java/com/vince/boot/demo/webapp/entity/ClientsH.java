...
/**
 * ClientsH generated by hbm2java
 */
@Entity
@Table(name = "d_clients_h")
public class ClientsH implements java.io.Serializable {
	...
	public ClientsH(long id, int userInsert, Date timeInsert) {
		this.id = id;
		this.userInsert = userInsert;
		this.timeInsert = timeInsert;
	}

	public ClientsH(long id, int userInsert, Integer userUpdate, Date timeInsert, Date timeUpdate) {
		this.id = id;
		this.userInsert = userInsert;
